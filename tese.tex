...
\input{ex_cap2}
\input{ex_cap3}
% \input{ex_cap4_biblatex}  % Este capítulo depende do uso do pacote biblatex.
\input{ex_cap4_bibtex}  % Este capítulo é uma versão do arquivo ex_cap4_biblatex.
...
% tese.bib.
\bibliography{tese,biblatex_style_samples/sample.bib,biblatex_style_samples/sample-abel.bib}
%
...
\input{ex_ape1}
\input{ex_ape2}
%\input{ex_ape3}  % Este apêndice lista os estilos do biblatex.
\input{ex_ape4}
